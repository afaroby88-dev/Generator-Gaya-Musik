export const OPTIONS = {
  genre: [
    ...
    "Bossa Nova", "Swing", "Blues", "Folk", "Bluegrass", "Country", "Americana", "Klasik", "Orkestra", "Kamar", 
  ...
  instrumen: [
    ...
    "Trompet", "Saksofon", "Trombon", "Tuba", "French Horn", "Seruling", "Klarinet", "Oboe", "Fagot", "Harmonika", "Bagpipes",
    "Drum", "808 Bass", "TR-909", "Drum Machine", "Perkusi Akustik", "Perkusi Sinematik", "Timpani", "Silofon", "Marimba",
    "Congas", "Bongos", "Tamburin", "Shaker", "Cowbell",
    "Gamelan", "Kendang", "Suling", "Angklung", "Koto", "Shamisen", "Erhu", "Tabla", "Djembe", "Didgeridoo"
  ],
  suasana: [
    "Epik", "Melankolis", "Membangkitkan Semangat", "Agresif", "Bermimpi", "Gelap", "Energetik", "Sinematik", "Romantis", 
    "Santai", "Menyeramkan", "Nostalgia", "Penuh Harapan", "Marah", "Tenang", "Misterius", "Ethereal", "Trippy", "Sedih",
    "Ajaib", "Lounge", "Megah", "Intens", "Damai", "Sensual", "Heroik", "Gothic", "Ceria", "Gelisah",
  ...
  tempo: ["40-60 BPM", "60-80 BPM", "80-100 BPM", "100-120 BPM", "Cepat (140+ BPM)", "Sangat Cepat (180+ BPM)"]
};
